...
- Readers: the catalog API merges this layer with the code CATALOG into one shape —
  ...
  against the payload.
- Migration **068** — BUILT 4 Sep 2026 (#1047, merged `2a00ef44`; 069 = the entry.where rewrite, outreach's) (trail: sealed as 060 on 1 Sep 2026, renumbered to 061 same day, then 062 on 2 Sep when #1038's crm_template took 061, then 066 on 3 Sep when the workflow rollout took 062–064 and buddy's #1022 took 065, then 068 the same day when buddy's #1073 took 066 and #1079's T25 delete guard took 067 — #1047 landed as 068/069 —
